...
from validation import validate_required, validate_ip, validate_enum, validate_timeout
...
class NetexecTool(BaseTool):
    ...
    def description(self) -> str:
        return "Run NetExec (nxc) for network protocol execution — SMB, WinRM, SSH, etc."
